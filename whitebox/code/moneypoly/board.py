...
class Board:
    ...
    def _create_properties(self):
        ...
        g = self.groups
        return [
            Property(PropertySpec("Mediterranean Avenue",   1,  60,  2),  group=g["brown"]),
            Property(PropertySpec("Baltic Avenue",          3,  60,  4),  group=g["brown"]),
            Property(PropertySpec("Oriental Avenue",        6,  100, 6),  group=g["light_blue"]),
            Property(PropertySpec("Vermont Avenue",         8,  100, 6),  group=g["light_blue"]),
            Property(PropertySpec("Connecticut Avenue",     9,  120, 8),  group=g["light_blue"]),
            Property(PropertySpec("St. Charles Place",      11, 140, 10), group=g["pink"]),
            Property(PropertySpec("States Avenue",          13, 140, 10), group=g["pink"]),
            Property(PropertySpec("Virginia Avenue",        14, 160, 12), group=g["pink"]),
            Property(PropertySpec("St. James Place",        16, 180, 14), group=g["orange"]),
            Property(PropertySpec("Tennessee Avenue",       18, 180, 14), group=g["orange"]),
            Property(PropertySpec("New York Avenue",        19, 200, 16), group=g["orange"]),
            Property(PropertySpec("Kentucky Avenue",        21, 220, 18), group=g["red"]),
            Property(PropertySpec("Indiana Avenue",         23, 220, 18), group=g["red"]),
            Property(PropertySpec("Illinois Avenue",        24, 240, 20), group=g["red"]),
            Property(PropertySpec("Atlantic Avenue",        26, 260, 22), group=g["yellow"]),
            Property(PropertySpec("Ventnor Avenue",         27, 260, 22), group=g["yellow"]),
            Property(PropertySpec("Marvin Gardens",         29, 280, 24), group=g["yellow"]),
            Property(PropertySpec("Pacific Avenue",         31, 300, 26), group=g["green"]),
            Property(PropertySpec("North Carolina Avenue",  32, 300, 26), group=g["green"]),
            Property(PropertySpec("Pennsylvania Avenue",    34, 320, 28), group=g["green"]),
            Property(PropertySpec("Park Place",             37, 350, 35), group=g["dark_blue"]),
            Property(PropertySpec("Boardwalk",              39, 400, 50), group=g["dark_blue"]),
        ]
